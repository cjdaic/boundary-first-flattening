...
public:
	...
	std::shared_ptr<RenderMesh> etcherMesh;
...
private:
	...
	static TextBox* patternSizeTextBox;
...
static std::string floatToString(float value, int precision = 4) {
	std::ostringstream ss;
...
static Slider* posXSlider;
static Slider* posYSlider;
